...
class InpaintGenerator1(BaseNetwork):
    ...
    def __init__(self, image_in_channels=4, out_channels=4, init_weights=True):
        ...
        # -----------------------
        self.ec_texture_1 = DepConvBNActiv(image_in_channels, 64, bn=False, sample='down-31',groups=4)
        self.ec_texture_2 = DepConvBNActiv(64, 128, sample='down-29',groups=64 )
        self.ec_texture_3 = DepConvBNActiv(128, 256, sample='down-27',groups=128)
        self.ec_texture_4 = DepConvBNActiv(256, 512, sample='down-13',groups=256)
        self.ec_texture_5 = DepConvBNActiv(512, 512, sample='down-13',groups=512)
        self.ec_texture_6 = DepConvBNActiv(512, 512, sample='down-13',groups=512)
        self.ec_texture_7 = DepConvBNActiv(512, 512, sample='down-13',groups=512)

        self.dc_texture_7 = DepConvBNActiv(512 + 512, 512, groups=512,activ='leaky')
        self.dc_texture_6 = DepConvBNActiv(512 + 512, 512,  groups=512,activ='leaky')
        self.dc_texture_5 = DepConvBNActiv(512 + 512, 512,  groups=512,activ='leaky')
        self.dc_texture_4 = DepConvBNActiv(512 + 256, 256,  groups=256,activ='leaky')
        self.dc_texture_3 = DepConvBNActiv(256 + 128, 128,  groups=128,activ='leaky')
        self.dc_texture_2 = DepConvBNActiv(128 + 64, 64, groups=64, activ='leaky')
        self.dc_texture_1 = DepConvBNActiv(64 + out_channels, 64, groups=4 ,activ='leaky')
